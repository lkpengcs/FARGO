...
def build_model(model_type, encoder, pretrain, classnum, depth, activation, aux=False):
    ...
    if model_type == "unet_smp":
        model = smp.Unet(
            ...
            decoder_channels=decoder_channels,                decoder_attention_type=None,
            in_channels=1,
            classes=classnum,
...
def create_train_arg_parser():
    ...
    parser.add_argument("--set", type=str, help="subset of OCTA-500")
    parser.add_argument("--data_path", type=str, help="path to img files")
    parser.add_argument("--mask_path", type=str, help="path to gt files")
    parser.add_argument("--val_data_path", type=str, help="path to img files")
    parser.add_argument("--val_mask_path", type=str, help="path to gt files")
    ...
    parser.add_argument("--encoder", type=str, default=None, help="encoder type")
    parser.add_argument("--encoder_depth", type=int, default=None, help="the depth of encoder")
    parser.add_argument("--activation", type=str, default=None, help="activation type")
    parser.add_argument("--pretrain", type=str, default=None, help="choose pretrained parameters")
    ...
    parser.add_argument("--attention", type=str, default=None, help="decoder attention type")
...
def create_validation_arg_parser():
    ...
    parser.add_argument("--encoder_depth", type=int, default=None, help="encoder")
